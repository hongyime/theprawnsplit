...
|---|---|---|---|---|
| **A1** | Public Nostr relays will accept and retain our event kind for ≥30 days | **PARTIAL — measured at t=5.1d (2026-08-27).** nos.lol and nostr.mom: 50/50 (100% retention). relay.primal.net: 0/50 (0%) — confirmed pruning between t=2.7d and t=3.7d, ~3-day retention window. offchain.pub: 15/15 retained but only 15/50 ingested (30%). Two of five default Nostr relays carry genuine redundancy for ≥30d; operated relay is load-bearing per D-23. 30-day gate: 2026-09-21. | Phase 2 Task 0 probe running since 2026-08-22T12:59:41Z; daily checks in `.agents/task0-retention.md` | Already hedged: operated relay is primary per D-23. Snapshots (REQ-SYN-14) mitigate independently. Consider replacing relay.primal.net with a relay that retains ≥30d. |
