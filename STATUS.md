...
|---|---|---|---|---|---|
| REQ-ID-01 | Built | `src/App.svelte`, `src/Trip.svelte`, `src/main.ts` | `test/platform-boundaries.test.ts`  | | source-shape |
...
| REQ-ID-04 | Built | `src/lib/events.ts`, `core/src/fold.ts`, `src/App.svelte`, `src/Trip.svelte` | `core/test/fold.test.ts`, `test/participants.test.ts`  | | source-shape |
...
| REQ-ID-08 | Built | `src/lib/participants.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/participant-claim-ui.test.ts`, `test/landing-ui.test.ts`  | | rendered |
| REQ-ID-09 | Built | `src/lib/participants.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/participant-claim-ui.test.ts`  | | rendered |
| REQ-ID-10 | Built | `src/lib/participants.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/participant-claim-ui.test.ts`  | | rendered |
| REQ-ID-11 | Built | `src/lib/join-link.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/join-recovery-boundary.test.ts`, `test/durability.test.ts`  | | rendered |
| REQ-ID-12 | Built | `core/src/identity.ts`, `core/src/fold.ts`, `src/App.svelte`, `src/Trip.svelte` | `core/test/fold.test.ts`, `test/duplicate-banner-ui.test.ts` | CR-011 closed the CR-010 gap: `test/duplicate-banner-ui.test.ts` now asserts the possible-duplicate-participants banner (both labels, "without changing balances automatically", Merge / Not same append-only actions); fold-side assertion remains at `core/test/fold.test.ts:367` | rendered |
...
| REQ-ID-15 | Built | `src/lib/expense-command.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/expense-command.test.ts`, `test/landing-ui.test.ts`  | | rendered |
...
| REQ-MON-02 | Built | `core/src/money.ts`, `src/lib/expense-command.ts`, `src/App.svelte`, `src/Trip.svelte` | `core/test/money.test.ts`, `test/expense-command.test.ts`  | | source-shape |
...
| REQ-MON-07 | Built | `src/lib/events.ts`, `src/db/repo.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/currency-onboarding.test.ts`  | | source-shape |
...
| REQ-MON-09 | Built | `src/lib/expense-display.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/expense-display.test.ts`, `test/common-expense-ui.test.ts`  | | rendered |
...
| REQ-SET-02 | Built | `src/App.svelte`, `src/Trip.svelte`, `src/lib/settlement-command.ts` | `test/platform-boundaries.test.ts`  | | source-shape |
...
| REQ-SET-07 | Built | `core/src/fold.ts`, `src/lib/settlement-history.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/settlement-history.test.ts`, `test/settlement-ui.test.ts`  | | source-shape |
| REQ-SET-08 | Built | `core/src/fold.ts`, `src/lib/settlement-command.ts`, `src/App.svelte`, `src/Trip.svelte` | `core/test/fold.test.ts`, `test/settlement-command.test.ts`, `test/settlement-ui.test.ts`  | | rendered |
...
| REQ-SYN-13 | Built | `src/lib/durability.ts`, `src/lib/manual-fallback.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/manual-fallback.test.ts`, `test/manual-fallback-ui.test.ts`  | | source-shape |
| REQ-SYN-14 | Built | `src/relay/sync.ts` | `test/sync.integration.test.ts`  | | source-shape |
| REQ-SYN-15 | Built | `src/lib/sync-labels.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/sync-labels.test.ts`, `test/sync-honesty-ui.test.ts`  | | rendered |
| REQ-SYN-16 | Built | `src/lib/manual-fallback.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/manual-fallback.test.ts`, `test/manual-fallback-ui.test.ts`  | | source-shape |
...
| REQ-SYN-22 | Built | `core/src/fold.ts`, `src/lib/freeze-policy.ts`, `src/App.svelte`, `src/Trip.svelte` | `core/test/properties.test.ts`, `test/freeze-policy.test.ts`, `test/protection-status-ui.test.ts`  | | rendered |
...
| REQ-DUR-01 | Built | `src/lib/durability.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/storage-persistence-ui.test.ts`, `test/platform-boundaries.test.ts`  | | source-shape |
| REQ-DUR-02 | Built | `src/lib/durability.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/pwa-install.test.ts`, `test/durability-prompts-ui.test.ts`  | | source-shape |
...
| REQ-DUR-05 | Built | `src/lib/durability.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/protection-status-ui.test.ts`  | | rendered |
| REQ-DUR-06 | Partial | `src/lib/join-link.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/join-recovery-boundary.test.ts`, `test/durability.test.ts` | Recovery-before-render ordering is only source-shape containment (`if (joinBlocked) await runSync();`); no behavioural test asserts the sync attempt precedes rendering or that recovery completes | rendered |
| REQ-DUR-07 | Built | `src/lib/durability.ts` | `test/export-prompt-ui.test.ts`, `test/durability-prompts-ui.test.ts`  | | source-shape |
| REQ-DUR-08 | Built | `src/lib/durability.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/durability.test.ts`, `test/durability-prompts-ui.test.ts`  | | source-shape |
| REQ-DUR-09 | Built | `src/lib/join-link.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/join-recovery-boundary.test.ts`, `test/manual-fallback-ui.test.ts` | Import-as-primary asserted at `test/manual-fallback-ui.test.ts:32` (`primary-link` + `Import JSON` in the recovery panel), not in the previously cited durability tests | rendered |
| REQ-DUR-10 | Built | `src/lib/join-link.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/manual-fallback-ui.test.ts` | First-join vs eviction distinction asserted at `test/manual-fallback-ui.test.ts:32` (`recoveryMode === "evicted"` headings, primary-link import promoted only when evicted) | rendered |
...
| REQ-SEC-07 | Built | `core/src/identity.ts`, `src/lib/participants.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/participants.test.ts`, `test/participant-claim-ui.test.ts`  | | rendered |
...
| REQ-SEC-09 | Built | `src/lib/durability.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/export-security.test.ts`, `test/identity-backup-ui.test.ts`  | | source-shape |
| REQ-PLT-01 | Built | `vite.config.ts`, `vercel.json` | `test/platform-boundaries.test.ts`  | | source-shape |
| REQ-PLT-02 | Built | `public/manifest.webmanifest`, `index.html`, `src/lib/durability.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/pwa-install.test.ts`  | | source-shape |
...
| REQ-LIF-02 | Built | `src/lib/archive.ts`, `src/lib/lifecycle.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/archive.test.ts`, `test/lifecycle.test.ts`  | | source-shape |
| REQ-LIF-03 | Built | `src/lib/archive.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/archive.test.ts`, `test/phase5-archive-acceptance.test.ts`  | | source-shape |
| REQ-LIF-04 | Built | `src/lib/archive.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/archive.test.ts`, `test/phase5-archive-acceptance.test.ts`  | | source-shape |
| REQ-LIF-05 | Built | `src/lib/lifecycle.ts`, `src/relay/sync.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/lifecycle.test.ts`, `test/lifecycle-ui.test.ts`  | | rendered |
| REQ-LIF-06 | Built | `src/lib/archive.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/archive.test.ts`, `test/lifecycle-ui.test.ts`  | | rendered |
| REQ-LIF-07 | Built | `src/lib/archive.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/archive.test.ts`, `test/lifecycle-ui.test.ts`  | | rendered |
| REQ-UX-01 | Built | `src/lib/expense-command.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/expense-workflow-ui.test.ts`, `test/common-expense-ui.test.ts`  | | rendered |
| REQ-UX-02 | Built | `src/App.svelte`, `src/Trip.svelte`, `src/lib/join-link.ts` | `test/landing-ui.test.ts`, `test/participant-claim-ui.test.ts`  | | rendered |
| REQ-UX-03 | Built | `src/lib/events.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/currency-onboarding.test.ts`  | | source-shape |
| REQ-UX-04 | Built | `src/App.svelte`, `src/Trip.svelte` | `test/empty-state-ui.test.ts`  | | rendered |
| REQ-UX-05 | Built | `src/App.svelte`, `src/Trip.svelte`, `src/main.ts`, `index.html` | `test/platform-boundaries.test.ts`  | | source-shape |
| REQ-UX-06 | Built | `src/lib/sync-labels.ts`, `src/App.svelte`, `src/Trip.svelte` | `test/sync-honesty-ui.test.ts`, `test/sync-labels.test.ts`  | | rendered |
